...
void Equation::countTangentPoint()
{
  ...
  std::cout << "\n sss tangent point is " << tangent._1_.X << " " << tangent._1_.Y << "\n\n";
}
...
void Equation::getTransitPoint(Point2D& point)
{
  ...
  {
    std::cout << "flag " << getDistance(point.X, point.Y, m_a, m_b) << "\n";
...
int main()
{
  ...
  Point2D initial_p(218.794, 293.16);
